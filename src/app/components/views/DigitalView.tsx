...
// Importing the elements we need for the component. React plus dates which is super helpful for time formatting
    ...
    >
      ...
      <div className="grid grid-cols-5 gap-6">
        ...
        <div className="space-y-4">
          ...
          {/* Another empty div for alignment if there's no DST info */}
          ...
          <div className="flex justify-center mt-[-8px]">
            <div className="bg-gray-800/80 p-6 rounded-2xl shadow-lg flex flex-col items-center border border-gray-700/30 backdrop-blur-sm">
              ...
              {/* The user's local time display - big and easy to read */}
              <div className="flex items-baseline space-x-1">
        ...
        {selectedTimezones.map((tz, idx) => (
          <div key={idx} className="space-y-4">
            ...
            {/* Render the digital clock for this timezone */}
